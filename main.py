...
if __name__ == '__main__':
    ...
    for i in range(11, 12):
        ...
        two_col_loc = f"data\\raw\\BMC_{i}_2\\*\\*.xml"
        four_col_loc = f"data\\raw\\BMC_{i}_4\\*\\*.xml"
        ...
        if RAW_TEXT:
            ...
            with open(os.path.join(out_path, f"_full_text_single_line_v1.txt"), "w", encoding="utf-8") as f:
